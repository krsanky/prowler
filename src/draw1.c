 ...
 * ready-to-be-used cairo_t that is already clipped to only draw the exposed
 * areas of the widget
 */
static		gboolean
...
/*
 * Handle motion events by continuing to draw if button 1 is still held down.
 * The ::motion-notify signal handler receives a GdkEventMotion struct which
...
activate(GtkApplication * app, gpointer user_data)
{
	 ...
	 * to. In particular, we need to ask for the button press and motion
	 * notify events that want to handle.
	 */
